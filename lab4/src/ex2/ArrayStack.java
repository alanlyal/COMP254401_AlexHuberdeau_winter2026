...
public class ArrayStack<E> implements Stack<E> {
  ...
  public static void main(String[] args) {
      ...
      System.out.println("assigment 4 stuff");
      Stack<Integer> s = new ArrayStack<>();
      Stack<Integer> t = new ArrayStack<>();
      s.push(1);
      s.push(2);
      s.push(3);
      System.out.println("s stack before transfer" + s);
      System.out.println("t stack before transfer" + t);
      transfer(s,t);
      System.out.println("s stack after transfer" + s);
      System.out.println("t stack after transfer" + t);
  }
}
