...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public AbstractHashMap(double loadFactor) {
    ...
    public AbstractHashMap(int cap, double loadFactor) {
      this(cap,109345121, loadFactor);// the default prime
    }
    public AbstractHashMap()
    {
        this(17, 109345121,0.5);// the default values
    }
//end of new
    // public methods
  /**
  ...
  public V put(K key, V value) {
    ...
    if ((double)n/capacity>maxLoadFactor)//if the current load is bigger then the max
